...
<body>
    <div class="container">
        <nav class="navbar navbar-light bg-info justify-content-between ps-4 pe-4">
            <a class="navbar-brand" href="index.php">WE LUCK SHIRT </a>
            <div>
            ...
            <div class="col-md-5">
                <form action="index.php" method="get">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Search for shirts..." name="searchtext">
        ...
        <div class="row mt-2 ms-4 me-4">
            ...
            if (!empty($_GET['searchtext'])) {
                ...
                foreach ($result->products as $item){
                    ...
                    if ((strpos($shirtName, $searchtext) !== FALSE) || (strpos($des, $searchtext) !== FALSE)){
                        showshirt($shirtImg, $shirtName, $des, $artistName, $price);
                        $found++;
                    }
                }
            }
            ...
            function showshirt($shirtimg, $shirtName, $des, $artistName, $price){
                echo '
                    <div class="col-lg-4 col-md-6 mt-3 ">
                        <div class="card h-100">
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">' . $shirtName . '</h5>
                                        <p><b>Des:</b> ' . $des . '</p>
